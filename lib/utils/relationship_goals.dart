...
const List<RelationshipGoal> relationshipGoals = [
  RelationshipGoal(label: 'Life Partner', description: 'Ready for the long haul', icon: Icons.auto_awesome_rounded),
  ...
  RelationshipGoal(label: 'Still Figuring It Out', description: 'Exploring my options', icon: Icons.help_outline_rounded),
  RelationshipGoal(label: 'Monogamous', description: 'Strictly one-on-one', icon: Icons.lock_person_rounded),
  RelationshipGoal(label: 'Ethical Non-Monogamy', description: 'Open communication style', icon: Icons.all_inclusive_rounded),
